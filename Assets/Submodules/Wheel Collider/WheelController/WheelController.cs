...
namespace NWH.WheelController3D
{
    ...
    public class WheelController : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            if (Visual == null)
            {
                Visual                  = new GameObject($"{name}_emptyVisual");
                Visual.transform.parent = transform;
                Visual.transform.SetPositionAndRotation(transform.position - transform.up * (spring.maxLength * 0.5f), 
                    transform.rotation);
            }
        ...
        public void OnPhysicsSubstep(float t, float dt, int i)
        {
            ...
            // Update friction
            _contactVelocity = parentNRigidbody.GetPointVelocity(wheel.worldPosition - transform.up * wheel.radius) - _surfaceVelocity;
        ...
        private void WheelUpdate()
        {
            ...
            // Apply visual position and rotation
            wheel.Visual.transform.SetPositionAndRotation(newPosition, rotation);
